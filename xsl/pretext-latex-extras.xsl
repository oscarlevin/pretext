...
<!-- Produce worksheets: -->
<xsl:param name="worksheets" select="'no'"/>
...
<xsl:template match="sidebyside[image]" mode="slides">
...
<xsl:template name="slides-main-file">
  <exsl:document href="./slides/slides.tex" method="text" >
...
<xsl:template name="worksheets-main-file">
  <exsl:document href="./worksheets/worksheets.tex" method="text" >
...
<xsl:template name="slides-preamble-file" >
  <exsl:document href="./slides/slides-preamble.tex" method="text" >
    <xsl:call-template name="slides-preamble"/>
  </exsl:document>
</xsl:template>

<xsl:template name="worksheets-preamble-file" >
  <exsl:document href="./worksheets/worksheets-preamble.tex" method="text" >
    <xsl:call-template name="worksheets-preamble"/>
  </exsl:document>
</xsl:template>

<xsl:template name="notes-preamble-file" >
  <exsl:document href="./notes/notes-preamble.tex" method="text" >
...
<!-- Common elements to all preambles. -->
<!-- As entries break particular modes, they are removed -->
<!-- and put in as needed to other modes. -->
<!-- This template can be called in the middle of each of those. -->
<!-- Taken originally from mathbook-latex.xsl on 4-17-2018 -->
<!-- (It might be necessary to break this in two parts eventually ) -->

<xsl:template name="preamble-common" >
