...
<!-- An image nested deeper than a panel of a "sidebyside" (within -->
<!-- the "statement" of an "exercise" panel, say) comes here too:  -->
<!-- the panel's own width is the 100% the percentages refer to,   -->
<!-- so the author's @width scales the image within its panel.     -->
